...
import com.ryggs.towapp.riderapp.Fragments.BottomSheetRiderFragment;
import com.ryggs.towapp.riderapp.Helper.CustomInfoWindow;
import com.ryggs.towapp.riderapp.Interfaces.IFCMService;
import com.ryggs.towapp.riderapp.Interfaces.locationListener;
...
import com.ryggs.towapp.riderapp.Util.Location;
...
public class Home extends AppCompatActivity
    ...
    private void findDriver() {
        ...
        if(isUberX)
            driverLocation=FirebaseDatabase.getInstance().getReference(Common.driver_tbl).child("TruckX");
        else
            driverLocation=FirebaseDatabase.getInstance().getReference(Common.driver_tbl).child("Truck Black");
